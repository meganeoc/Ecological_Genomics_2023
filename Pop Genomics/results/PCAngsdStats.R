...
COV <- as.matrix(read.table("allRSe3_poly.cov")) # read in the genetic covariance matrix
...
names <- read.table("allRSe3_bam.list")
...
q <- read.table("allRSe3_poly.admix.4.Q", sep=" ", header=F)
